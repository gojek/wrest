...
* bundle install
* rake server
* Open {http://localhost:10005}[http://localhost:10005] in your browser
* Once you've seen it work, take a look at link:lib/models/facebook_client.rb to see what's involved.
