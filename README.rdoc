...
Wrest is a ruby REST client library which allows you to quickly build object oriented wrappers around any web service. It has two components - Wrest Core and Wrest::Resource. Wrest strongly favours immutable objects and avoids globals/class methods/static methods making it better suited for use as a library, especially in multi-threaded environments. Wrest runs on Ruby 1.8, 1.9 and JRuby.
