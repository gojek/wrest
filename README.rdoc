...
Since no single framework can provide object oriented wrappers for _all_ available web services, it follows that Wrest should focus on providing you with the tools to roll your own. Wrest::Resource is an example of this - an object oriented wrapper for the kind of REST APIs exposed by Rails applications.
