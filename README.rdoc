...
A Memcached based caching back-end is available in Wrest. For instructions on how to install Memcached on your system, refer to http://code.google.com/p/memcached/wiki/NewInstallFromPackage.
