...
* Caching
  ...
  A detailed writeup regarding caching as defined by RFC 2616, and how Wrest implements caching is at [Caching.markdown](https://github.com/kaiwren/wrest/blob/caching/Caching.markdown)
