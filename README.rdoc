...
==== Get
A couple of ways to get the Yahoo news as hash map (needs the JSON gem - gem install json). You can try this in the console by running script/console.
...
The Wrest logger can be set and accessed through Wrest.logger and is configured by default to log to STDOUT.
