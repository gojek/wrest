...
Allows any class to hold an attributes hash, somewhat like ActiveResource. It also supports several extensions such as support for typcasting attribute values.
