...
==== Caching
  ...
  You can create your own back-ends for Wrest caching by implementing the functions defined in https://github.com/kaiwren/wrest/blob/master/lib/wrest/components/cache_store/memcached.rb
